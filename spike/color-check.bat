@echo off
REM Phase 5: the ray march against POV-Ray, pixel for pixel rather than outline for outline.
...
"%BIN%\render_scene.exe" --pov-match --width %WIDTH% --height %HEIGHT% !SCENE_ARGS!
if errorlevel 1 (
